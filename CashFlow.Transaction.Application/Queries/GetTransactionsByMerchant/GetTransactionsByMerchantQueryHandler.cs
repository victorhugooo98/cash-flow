...
public class
    GetTransactionsByMerchantQueryHandler : IRequestHandler<GetTransactionsByMerchantQuery, IEnumerable<TransactionDto>>
{
    ...
    public async Task<IEnumerable<TransactionDto>> Handle(GetTransactionsByMerchantQuery request,
